...
export const en = {
    ...
    'page.header.navbar.trade': 'Beta Trading',
    'page.header.navbar.wallets': 'Web Wallets',
    'page.header.navbar.mining': 'Crypto Mining',
    ...
    'page.body.landing.marketInfo.title.text1': 'Welcome to Triple Zen Chateau.',
    'page.body.landing.marketInfo.title.text2': 'Altcoin Web Wallets, Beta Trading, Beta Mining, Beta Staking.',
    'page.body.landing.marketInfo.title.text3': 'Providing easy to use ways to get into Crypto Currencies.',
    'page.body.landing.marketInfo.title.button1': 'Beta Staking',
    'page.body.landing.marketInfo.title.button2': 'Beta Trading',
    'page.body.landing.marketInfo.title.button': 'Look Around',

    'page.body.landing.platformInfo.item.first.value': '3K+',
    ...
    'page.body.landing.register.item.text': 'We accomodate in getting you started with staking, trading, mining and more.',
    'page.body.landing.register.item.button': 'register your account',

    'page.body.landing.features.title': 'Triple Zen Features',
    'page.body.landing.features.features.item1.title': 'Beta Trading Exchange',
    'page.body.landing.features.features.item2.title': 'Staking Platform',
    'page.body.landing.features.features.item3.title': 'Mining Contracts',
    ...
    'page.body.landing.features.features.item1.text': 'Our beta exchange allows our users to easily exchange Bitcoin, Ethereum, Litecoin, Dingocoin and many other digital assets with minimal slippage.',
    'page.body.landing.features.features.item2.text': 'Our staking platform is currently in development.',
    'page.body.landing.features.features.item3.text': 'Our mining contracts will allow our users to mine at our facility using our pools and receive good stable returns from investing and compounding their rewards into growing a larger farm for themselves.',
    ...
    'page.body.landing.features.features.item6.text': 'Our Websocket feed lets you easily gain access to real-time market data, while our API lets you develop secure, programmatic trading bots.',
    ...
    'page.body.landing.tradeOnTheGo.item.text3': 'All the power to check your earings in the palm of your hand.',
    'page.body.landing.tradeOnTheGo.item.button': 'let’s try',

    'page.body.landing.startTrading.title': 'Sign Up and Start Earning Today',
    'page.body.landing.startTrading.button1': 'register',
    'page.body.landing.startTrading.button2': 'trade',

    'page.body.landing.footer.exchange': 'Exchange',
    'page.body.landing.footer.stake': 'Staking',
    'page.body.landing.footer.mining': 'Crypto Mining',
    'page.body.landing.footer.wallets': 'Web Wallets',
    ...
    'page.body.landing.footer.rights': 'Triple Zen Chateau © All rights reserved.',

    'pagy.body.footer.powered_by': 'Powered by',


    /* Wallets */
    'page.body.wallets.estimated_value': 'Total Value',

    'page.body.wallets.locked': 'Locked',
    'page.body.wallets.staked': 'Staked',
    'page.body.wallets.mining': 'Mining',
    ...
    'page.body.wallets.tabs.mining': 'Mining Contracts',

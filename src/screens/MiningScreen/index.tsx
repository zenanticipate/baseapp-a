...
class MiningComponent extends React.Component<Props, WalletsState> {
    ...
    private renderTabs() {
        ...
        return [
            ...
            {
                content: tab === this.translate('page.body.wallets.tabs.mining') ? this.renderMining() : null,
                label: this.translate('page.body.wallets.tabs.mining'),
                disabled: !showWithdraw,
            },
        ];
    }
...
export const MiningScreen = compose(
    injectIntl,
    withRouter,
    connect(mapStateToProps, mapDispatchToProps),
)(MiningComponent) as React.ComponentClass;
